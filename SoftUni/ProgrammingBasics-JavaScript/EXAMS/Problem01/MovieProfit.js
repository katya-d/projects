...
function movieProfit(input) {
    ...
    let cinemaPercent = Number(input.shift());

    let income = (daysNumber*ticketsNumber)*ticketPrice;
    let cinemaMoney = income*(cinemaPercent/100);

    let netIncome = income-cinemaMoney;

    console.log(`The profit from the movie ${movieName} is ${netIncome.toFixed(2)} lv.`);
}
