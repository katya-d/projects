...
function oscarCeremony(input) {
    let hallRentPrice = Number(input.shift());

    let statuettesPrice = hallRentPrice -(hallRentPrice*0.30);
    let cateringPrice = statuettesPrice - (statuettesPrice*0.15);
    let soundSystemPrice = cateringPrice / 2;

    let totalCosts = hallRentPrice + statuettesPrice + cateringPrice + soundSystemPrice;
