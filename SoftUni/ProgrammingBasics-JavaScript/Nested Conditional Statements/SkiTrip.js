...
 Втори ред - вид помещение - "room for one person", "apartment" или "president
apartment"
...
function skiTrip(input) {
    let stayDays = Number(input.shift());
    ...
    if (roomType === "room for one person") {
        ...
        if (stay < 10) {
            let middlePrice = stay * 25.00;

            if (rating === "positive") {
                let totalPrice = middlePrice - (middlePrice * 0.30);
                let discount = totalPrice*0.25;
                let endPrice = totalPrice + discount;
            ...
            if (rating === "positive") {
                let totalPrice = middlePrice - (middlePrice * 0.50);
                let discount = totalPrice*0.25;
                let endPrice = totalPrice + discount;
            ...
            if (rating === "positive") {
                let totalPrice = middlePrice - (middlePrice * 0.35);
                let discount = totalPrice*0.25;
                let endPrice = totalPrice + discount;
        ...
        if (stay < 10) {
            let middlePrice = stay * 35.00;

            if (rating === "positive") {
                let totalPrice = middlePrice - (middlePrice * 0.10);
                let discount = totalPrice*0.25;
                let endPrice = totalPrice + discount;
            ...
            if (rating === "positive") {
                let totalPrice = middlePrice - (middlePrice * 0.20);
                let discount = totalPrice*0.25;
                let endPrice = totalPrice + discount;
            ...
            if (rating === "positive") {
                let totalPrice = middlePrice - (middlePrice * 0.15);
                let discount = totalPrice*0.25;
                let endPrice = totalPrice + discount;
